...
function Move_start(){
    Macros['Speed'] = {fun:set_speed,vis:'all',txt:'?{Change Speed}'}
    Macros['Back'] = {fun:back_turn,vis:'all',txt:''}
    Macros['Give_Turn'] = {fun:give_turn,vis:'GM',txt:''}
    Macros['Attach'] = {fun:attach,vis:'GM',txt:''}
}
