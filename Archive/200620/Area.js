class AdvTkn_Area {
    ...
    constructor(main) {
        ...
        if (!state[main.mask].Areas)


        main.Macros['Area'] = {fun:this.create_area,vis:'all',txt:
        '?{Select Shape|'+
        ...
        main.Macros['Size'] = {fun:this.set_size,vis:'GM',txt:
            '?{Height} ?{Width}'
        } 
    ...
    Pnt       { constructor(x,y)      { this.x = x; this.y = y                } }
    Line      { constructor(pnt1,pnt2){ this.pnt1 = pnt1; this.pnt2 = pnt2    } }
    Circle    { constructor(pnt,r)    { this.pnt = pnt; this.r = r            } }
    ...
    function new_handle(T,L,R,P,S,player){
        var obj = createObj('graphic',{
            ...
            left:L,
            top:T,
            width:Settings.handle_size*70/S,
            height:Settings.handle_size*70/S,
            rotation: R,
            layer: 'objects',
            isdrawing: true,
    ...
    function get_area(id){
        if (id in state.Area.Areas){
            return state.Area.Areas[id]
        } else {
